            ...
            <div className="mt-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="p-4 border border-gray-100 rounded-md bg-gray-50">
                  <h3 className="text-sm font-semibold text-gray-900">Licitações</h3>
                ...
                <div className="p-4 border border-gray-100 rounded-md bg-gray-50">
                  <h3 className="text-sm font-semibold text-gray-900">Contratos Administrativos</h3>
                ...
                <div className="p-4 border border-gray-100 rounded-md bg-gray-50">
                  <h3 className="text-sm font-semibold text-gray-900">Assessoria Preventiva</h3>
                ...
                <div className="p-4 border border-gray-100 rounded-md bg-gray-50">
                  <h3 className="text-sm font-semibold text-gray-900">Orientação em Procedimentos</h3>
